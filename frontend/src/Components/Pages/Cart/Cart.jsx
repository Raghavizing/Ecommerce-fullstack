  ...
  return (
    <div className='cart-page'>
      ...
      <div hidden={getCartItems() === 0}>
        <div className='row text-center m-0 cart-header'>
          ...
          <div className='col-md-6'>
            ...
            <div className='my-5'>
              <div className='d-flex justify-content-between'>
                <p className='my-auto'>Subtotal</p> <p className='my-auto'>${getTotal()}</p>
              </div>
              <hr />
              <div className='d-flex justify-content-between'>
                <p className='my-auto'>Shipping</p> <p className='my-auto'>Free</p>
              </div>
              <hr />
              <div className='d-flex justify-content-between'>
                <h5 className='my-auto'>Total</h5> <h5 className='my-auto'>${getTotal()}</h5>
              </div>
            </div>
